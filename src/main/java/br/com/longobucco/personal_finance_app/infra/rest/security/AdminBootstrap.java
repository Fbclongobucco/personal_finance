...
public class AdminBootstrap implements ApplicationRunner {
    ...
    public AdminBootstrap(UserRepository userRepository, CategoryRepository categoryRepository,
    ...
    public void run(ApplicationArguments args) {
        ...
        Category.defaultsFor(savedAdmin.getId()).forEach(categoryRepository::save);
    }
}
